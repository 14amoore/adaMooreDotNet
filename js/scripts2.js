$(function() {
  $(window).scroll(function() {
    if ($(this).scrollTop() > 60000) {
      $('body').addClass('changeColor16');
    }
    if ($(this).scrollTop() < 60000) {
      $('body').removeClass('changeColor16');
    }
    if ($(this).scrollTop() > 56000) {
      $('body').addClass('changeColor15');
    }
    if ($(this).scrollTop() < 56000) {
      $('body').removeClass('changeColor15');
    }
    if ($(this).scrollTop() > 52000) {
      $('body').addClass('changeColor14');
    }
    if ($(this).scrollTop() < 52000) {
      $('body').removeClass('changeColor14');
    }
    ...
    if ($(this).scrollTop() > 2000) {
      ...
      $('a').addClass('changeLink');
    }
    if ($(this).scrollTop() < 2000) {
      $('body').removeClass('changeColor');
      $('a').removeClass('changeLink');
    }
  });
});
